...
public class TVGuideNowPlayingAB extends TVGuideListActionBarThemedActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(Menu.NONE, R.id.playing_option_view_list, 10, R.string.guide_list)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS | MenuItem.SHOW_AS_ACTION_WITH_TEXT);
        menu.add(Menu.NONE, R.id.program_option_refresh,
                getResources().getBoolean(R.bool.i_am_tablet) ? 1 : 20, R.string.refresh)
